...
Bei der \textit{diskrete Rekombination} wählt man die Werte eines Gens für das Nachkommen aus, die besser geeignet sind. 
Am Beispiel \autoref{tabelleBeispiel} wurden jeweils immer nur die kleineren Werte für das Nachkommen ausgewählt. 
Die andere Möglichkeit ist die \textit{intermediäre Rekombination} anhand der Gene beider Elternteile wird der Durchschnitt von beiden Werten berechnet und als Gen für den Nachkommen weitergegeben.
...
Beim Two-point crossover hat man zwei überschneidungen der Eltern, sowie man bei dem unoform corssover jedes zweite Element mit dem Partner getauscht hat. 
...
Als Beispiel für eine Baumstuktur repräsentiert \autoref{fig:baumstruktur} die $4 - 23 * 2$.
