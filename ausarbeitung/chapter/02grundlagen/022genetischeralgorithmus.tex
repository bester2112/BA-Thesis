...
Falls man nur aus einem Elternteil ein Nachkomme erzeugen soll, wird dabei die Rekombination übersprungen und es wird mit der Mutation fortgefahren. Es gibt 2 Möglichkeiten die Nachfolger der zwei Eltern zu erzeugen. Bei der \textit{diskrete Rekombination} wählt man die Werte eines Gens für das Nachkommen aus, die für besser geeignet sind. Am Beispiel \autoref{tabelleBeispiel} wurden jeweils immer nur die kleineren Werte für das Nachkommen ausgewählt. Die andere Möglichkeit ist die \textit{intermediäre Rekombination} anhand der Gene beider Elternteile wird der Durchschnitt von beiden Werten berechnet und als Gen für den Nachkommen weitergegeben.
...
Die Rekombination einer Rekombination kann auf verschiedensten Arten repräsentiert werden. 
Dabei werden zwei oder mehrere Eltern miteinander gemischt.
