...
%% ==============================
Es gibt verschiedene Darstellungsm{\"o}glichkeiten um von Genen, bei denen ich hier auf die meist meist verwendeten Darstellungen eingehen werde. Das wissen, wurde aus der Ausarbeitung von \cite{flickevolutionare} entnommen.

Eine \textbf{Lineare Repr{\"a}sentation} besteht aus einer Folge $a_{0}a_{1}a_{2}...a_{n-1}$ von Symbolen fester L{\"a}nge, die aus einer definierten Symbolmenge $V$, dabei ist $a_{i} \in V$.   
